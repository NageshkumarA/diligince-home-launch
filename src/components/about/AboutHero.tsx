...
const AboutHero = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-corporate-50 via-white to-corporate-100">
      {/* Animated Background Elements */}
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-20 left-10 w-72 h-72 bg-corporate-200/20 rounded-full blur-3xl animate-float" />
        <div className="absolute bottom-20 right-10 w-96 h-96 bg-primary-200/20 rounded-full blur-3xl animate-float" style={{ animationDelay: "2s" }} />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-corporate-300/10 rounded-full blur-3xl animate-pulse" />
      </div>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid md:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-corporate-600/10 rounded-full mb-6">
              <Building2 className="w-4 h-4 text-corporate-600" />
              <span className="text-sm font-medium text-corporate-700">Established 2024</span>
            </div>
            
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-corporate-900 mb-6 leading-tight">
              Thinkvate
              <br />
              <span className="text-corporate-600">Solutions</span>
            </h1>
            
            <p className="text-xl md:text-2xl text-corporate-700 mb-8 leading-relaxed">
        ...
        <div className="absolute bottom-8 left-1/2 -translate-x-1/2 animate-bounce">
          <div className="w-6 h-10 border-2 border-corporate-400 rounded-full flex items-start justify-center p-2">
            <div className="w-1 h-2 bg-corporate-600 rounded-full animate-pulse" />
          </div>
        </div>
      </div>
    </section>
