  ...
  return <Card className="bg-white border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
      ...
      <CardContent className="p-6">
        <div className="space-y-4 max-h-96 overflow-y-auto">
          {mockMessages.map((message, index) => <div key={message.id} className={`p-5 rounded-xl border transition-colors hover:bg-gray-50 ${message.unread ? 'bg-blue-50 border-blue-200' : 'bg-gray-50 border-gray-100'}`}>
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      {message.hasAttachment && <div className="flex items-center gap-2 text-sm text-gray-600">
