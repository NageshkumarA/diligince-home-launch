...
export const EquipmentFleet = () => {
  ...
  return <Card className="bg-white border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
      <CardHeader className="flex flex-row items-center justify-between">
        ...
        <Button className="text-white bg-pink-700 hover:bg-pink-600">
          Manage Equipment
        </Button>
      </CardHeader>
      <CardContent>
        ...
        <div className="flex gap-4 mb-4">
          <div className="relative flex-1">
            ...
            <Input placeholder="Search equipment..." value={searchTerm} onChange={e => setSearchTerm(e.target.value)} className="pl-10 border-gray-200 focus:border-blue-300 focus:ring-blue-200 bg-slate-50" />
          </div>
          <select value={filterStatus} onChange={e => setFilterStatus(e.target.value)} className="px-3 py-2 border border-gray-200 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-200 focus:border-blue-300 bg-pink-700">
        ...
        <div className="overflow-x-auto">
          <table className="w-full">
            ...
            <tbody>
              {filteredEquipment.map(equipment => <tr key={equipment.id} className="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                  ...
                  <td className="py-3 px-4">
                    <Button variant="outline" size="sm" className="border-blue-200 text-blue-50 bg-pink-700 hover:bg-pink-600">
                      Edit
                    </Button>
                  </td>
                </tr>)}
