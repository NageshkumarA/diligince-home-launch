...
export const WorkTimeline = ({ timeline, workStatus }: WorkTimelineProps) => {
      ...
      <CardContent>
        ...
        <div className="mt-6 p-4 bg-gray-50 rounded-lg">
          <div className="flex items-center justify-between">
            ...
            <Badge 
              className={
                workStatus === 'approved' ? 'bg-green-600' :
                workStatus === 'completed' ? 'bg-blue-600' :
                workStatus === 'in_progress' ? 'bg-orange-600' :
                'bg-gray-600'
              }
            >
