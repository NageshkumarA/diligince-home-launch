...
import { Plus, Award, Calendar, AlertTriangle, Upload, Edit, Trash2 } from 'lucide-react';
...
const ProfessionalCertifications = () => {
  ...
  const columns: ColumnConfig[] = [
      ...
      render: (value, row) => (
        <div className="flex items-start space-x-3">
          ...
          <div>
            ...
            <div className="text-sm text-muted-foreground">{row.issuingOrganization}</div>
    ...
    },
    {
      ...
      filterOptions: [
        ...
        { key: 'Project Management', value: 'Project Management', color: '#ddd6fe' },
        { key: 'DevOps', value: 'DevOps', color: '#fef3c7' },
        { key: 'Security', value: 'Security', color: '#fed7aa' },
        { key: 'Data Science', value: 'Data Science', color: '#fee2e2' }
      ]
    },
    {
      name: 'level',
    ...
    },
    {
      ...
      render: (value) => (
        <span className={`text-sm ${
          value <= 0 ? 'text-red-600' : value <= 90 ? 'text-yellow-600' : 'text-green-600'
        }`}>
  ...
  const handleEditSelected = () => {
    console.log('Edit selected certifications');
  };

  const handleDeleteSelected = () => {
    console.log('Delete selected certifications');
  };
  ...
  return (
    <div className="p-6 bg-background min-h-screen">
      <div className="mb-6 flex justify-between items-start">
        <div>
          <h1 className="text-3xl font-bold text-foreground mb-2">Certifications Management</h1>
          <p className="text-muted-foreground">
            Track and manage your professional certifications and credentials
          </p>
        </div>
        <div className="flex gap-3">
          <Button onClick={handleUploadCertificate} variant="outline">
