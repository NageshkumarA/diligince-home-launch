  ...
  const deliveries = [
    {
      ...
      milestones: [
        { location: "Mumbai Depot", time: "Jan 12, 08:00", status: "completed" },
        { location: "Pune Checkpoint", time: "Jan 12, 14:30", status: "completed" },
        { location: "Solapur Junction", time: "Jan 13, 09:15", status: "completed" },
        { location: "Bangalore Outskirts", time: "Jan 14, 18:00", status: "current" },
        { location: "Chennai Destination", time: "Jan 15, 14:30", status: "pending" }
      ]
    },
    {
      id: "DEL-002",
      ...
      milestones: [
        { location: "Gujarat Depot", time: "Jan 14, 06:00", status: "current" },
        { location: "Mumbai Highway", time: "Jan 14, 14:00", status: "pending" },
        { location: "Pune Junction", time: "Jan 15, 08:00", status: "pending" },
        { location: "Bangalore Destination", time: "Jan 20, 10:00", status: "pending" }
      ]
    },
    {
      id: "DEL-003",
      ...
      milestones: [
        { location: "Delhi Depot", time: "Jan 12, 08:00", status: "completed" },
        { location: "Gurgaon Checkpoint", time: "Jan 12, 11:30", status: "completed" },
        { location: "Haryana Destination", time: "Jan 12, 16:00", status: "completed" }
      ]
    }
  ];
                    ...
                    <div className="flex-1">
                      ...
                      <div className="border-t pt-4">
                        ...
                        <div className="space-y-2">
                          {delivery.milestones.map((milestone, index) => (
