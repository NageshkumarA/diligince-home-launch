...
const PurchaseOrdersPending = () => {
  ...
  const columns: ColumnConfig[] = [
    ...
    },
    {
      ...
      isFilterable: true,
      filterOptions: [
        { key: 'Awaiting Approval', value: 'Awaiting Approval', color: '#fef3c7' },
        { key: 'Under Review', value: 'Under Review', color: '#ddd6fe' },
        { key: 'Pending Signature', value: 'Pending Signature', color: '#fed7aa' }
      ]
    }
  ];
  ...
  return (
    <div className="p-6 bg-background min-h-screen">
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-foreground mb-2">Pending Purchase Orders</h1>
