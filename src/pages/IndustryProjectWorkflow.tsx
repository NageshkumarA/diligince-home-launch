      ...
      <main className="flex-1 container max-w-7xl mx-auto px-4 py-8 pt-20">
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center justify-between">
            ...
            <Button variant="outline" onClick={handleBackToDashboard} className="flex items-center gap-2 bg-blue-700 hover:bg-blue-600">
        ...
        <div className="space-y-8">
          {/* Quote Review Stage */}
          {!isQuoteAccepted && <QuoteReviewTable quotes={projectWorkflow.quotes} onAcceptQuote={handleAcceptQuote} />}

          {/* PO Generation Stage */}
          {isQuoteAccepted && !isPOGenerated && projectWorkflow.acceptedQuote && <POTriggerCard acceptedQuote={projectWorkflow.acceptedQuote} onGeneratePO={handleGeneratePO} />}

          {/* Work Tracking Stage */}
          {isPOGenerated && <div className="grid lg:grid-cols-2 gap-8">
